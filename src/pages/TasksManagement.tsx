...
const TasksManagement = () => {
  ...
  const handleCreateTask = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const taskData = {
        ...
        reward_type: (formData.get("reward_type") === "AT" ? "AT" : "USDT") as
          | "AT"
          | "USDT",
        ...
        business_id: formData.get("business_id")
          ? Number(formData.get("business_id"))
          : undefined,
        completions: {
  ...
  const filteredLocalTasks = useMemo(
    ...
    [localTasks, filterTasks],
  );
  const filteredGlobalTasks = useMemo(
    () => filterTasks(globalTasks),
    [globalTasks, filterTasks],
  );
              ...
              <form onSubmit={handleCreateTask}>
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      <Label htmlFor="is_global">
                        Visibility <b>Local</b> (Aravt #{effectiveAravtId}) or
                        <b> Global</b> (All Aravts)
                      </Label>
                    ...
                    <div>
                      <Label htmlFor="one_time">
                        <b>One</b> or <b>Multiple</b> completions
                      </Label>
                  ...
                  <div className="space-y-4 pt-2 border-t">
                    ...
                    <div hidden>
                      <Label htmlFor="responsible_users_ids">
                        Responsible Users (IDs)
                      </Label>
                      <Input
